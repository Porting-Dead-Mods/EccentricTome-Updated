...
//            return 0;
//
//        if (!tag.contains(EccentricDataComponents.VERSION))
//            return 0;
//
//        return tag.getInt(EccentricDataComponents.VERSION);
//    }
//
//    public static void setVersion(ItemStack stack, int version) {
//        var tag = stack.getOrCreateTag();
//        tag.putInt(EccentricDataComponents.VERSION, version);
//    }
//
...
//
//        // Remove unused tags
//        tag.remove(EccentricDataComponents.key("name"));
//        tag.remove(EccentricDataComponents.key("mod"));
//
//        // Get old mods (books) tag
//        var books = EccentricDataComponents.key("books");
...
//        }
//        tag.put(EccentricDataComponents.MODS, mods);
//    }
}
